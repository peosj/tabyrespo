...
<head>
  ...
  <title>Qyk Pay | User Login</title>
...
<div class="container w-xxl w-auto-xs" ng-controller="SigninFormController" ng-init="app.settings.container = false;">
  ...
  <div class="m-b-lg">
    ...
    <form name="form" action="app/action/login.php" method="post" class="form-validation">
      ...
      <div class="list-group list-group-sm">
        ...
        <div class="list-group-item">
          ...
          <input type="text" placeholder="User Id" name="userid" class="form-control no-border" ng-model="user.email" required>
