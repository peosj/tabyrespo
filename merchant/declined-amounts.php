      ...
      <table ui-jq="dataTable" ui-options="{
        ...
        <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sales_list_query = "select * from cheque where cheque_status='Declined' AND user_id = '".$_SESSION['logid']."' order by cheque_id desc ";                                            
...

                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    ";
                                                            ...
                                                            echo"<td><a href='view-cheque-details.php?id=$id' class='btn btn-success btn-sm'>View Cheque Details</a></td></tr>";
