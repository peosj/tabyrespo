        ...
        <tbody>
                                        ...
                                        <?php
...

                                            {
                                                ...
                                                @$cheque_no = $sales_list_row['cheque_number'];

                                                $cheque_status = $sales_list_row['cheque_status'];

                                                $routing_no = $sales_list_row['routing_number'];
                                                ...
                                                <tr>
                                                    ...
                                                    echo "<a href='./view-cheque-detail.php?id=$id' class='btn btn-success btn-sm'>View Cheque</a>";
