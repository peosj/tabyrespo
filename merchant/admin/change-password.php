...
<head>
  ...
  <title>Qyk Pay | Change Password</title>
...
<?php //include('blocks/main-header.php');?>
    ...
    <div class="bg-light lter b-b wrapper-md" style="">
      ...
      <h1 class="m-n font-thin h3" style="text-align: center;">Change Passwod</h1>
   ...
   <div class="wrapper-md" ng-controller="FormDemoCtrl"> 
    ...
    $query = "select * from admin where emp_id = '".$_SESSION['logid']."'";
        ...
        <div class="panel-body">
          ...
          <form action="app/action/change-password.php" method="post" class="bs-example form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-offset-2 col-lg-10" style="margin-left: 24.667%;">

                <button type="submit" name="submit" class="btn btn-sm btn-info" style="font-size: 18px;">Change Password</button>
