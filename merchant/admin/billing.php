    ...
    <div class="well m-t bg-light lt">
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <p>
            Last Payment<br>
            2016-09-23 10:30:23 For $ 1,000/-<br>
        ...
        <div class="col-xs-4">
          ...
          <h4><?php echo $queryResult['firstname']; ?> <?php echo $queryResult['lastname']; ?></h4>
          <p>
            Email: <?php echo $queryResult['email']; ?><br>
            Phone: <?php echo $queryResult['phone']; ?><br>
