...
<head>
  ...
  <title>Qyk Pay | Pending Amounts</title>
...
<div class="bg-light lter b-b wrapper-md">
  ...
  <h1 class="m-n font-thin h3" style="text-align: center;">Pending Checks</h1>
      ...
      <table ui-jq="dataTable" ui-options="{
        ...
        <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sales_list_query = "select * from cheque where cheque_status='Pending' order by cheque_id desc ";                                            
