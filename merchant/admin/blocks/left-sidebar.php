              ...
              <a href="app.page.profile">
                <span class="thumb-lg w-auto-folded avatar m-t-sm">
                  <img src='
                    ...
                    ?>
                    '  class="img-circle" alt="User Image" style="height: 88px;width: 88px;"/>
                </span>
              </a>
              <a href="#" data-toggle="dropdown" class="dropdown-toggle hidden-folded">
                <span class="clear">
                  <span class="block m-t-sm">
                    <strong class="font-bold text-lt"><?php echo $_SESSION['logname'];?></strong> 
                    <b class="caret"></b>
                  </span>
                  <span class="text-muted text-xs block"><?php //echo $_SESSION['logrights'];?></span>
                </span>
              </a>
              <!-- dropdown -->
            ...
            <ul class="nav">
              ...
              <li>
                ...
                <ul class="nav nav-sub dk">
                  ...
                  <li>
                    <a href="./pending-withdrawal-request.php">
                      <span>Pending Withdrawal</span>
                    </a>
                  </li>
                  <li>
                    <a href="./approved-withdrawal-request.php">
                      <span>Approved Withdrawal</span>
                    </a>
                  </li>
                  <li>
                    <a href="./declined-withdrawal-request.php">
