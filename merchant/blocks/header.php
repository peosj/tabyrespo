<?php @session_start();?>
<?php
if(isset($_SESSION['logid'])&&strlen($_SESSION['logid'])>0)
{
    //echo $_SESSION['logid'];
}
else
{    
    ...
    echo"<div style='width:80%;text-align:center;margin:0 auto;padding:20px;border:1px solid #8a8a8a;'>Sorry ! You are not authenticated to view this page.</div>";
    exit;
}
?>
    <!-- header -->
  ...
  <header id="header" class="app-header navbar" role="menu">
      ...
      <div class="navbar-header bg-dark">
        ...
        <a href="#/" class="navbar-brand text-lt">
          ...
          <span class="hidden-folded m-l-xs">Qyk Pay</span>
      ...
      <div class="collapse pos-rlt navbar-collapse box-shadow bg-white-only">
        ...
        <form action="./search.php" class="navbar-form navbar-form-sm navbar-left shift" ui-shift="prependTo" data-target=".navbar-collapse" role="search" ng-controller="TypeaheadDemoCtrl">

          <div class="form-group">

            <div class="input-group">

              <input type="text" name="search" ng-model="selected" typeahead="state for state in states | filter:$viewValue | limitTo:8" class="form-control input-sm bg-light no-border rounded padder" placeholder="Search by name,email,phone and cheque number...">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            ...
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              ...
              <span class="hidden-sm hidden-md"><?php echo $_SESSION['logname'];?></span> <b class="caret"></b>
            ...
            <ul class="dropdown-menu animated fadeInRight w">
                    ...
                    <li>
                        ...
                        <a href="./profile.php" ui-sref="app.page.profile">My Account</a>

                    </li>

              <li>

                <a href="./change-password.php" ui-sref="app.docs">
              ...
              <li>
                ...
                <a href="./app/action/logout.php" ui-sref="access.signin">Logout</a>
