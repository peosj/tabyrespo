...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3" style="text-align: center;font-weight: bold;">Transaction Details</h1>
</div>
      ...
      <table ui-jq="dataTable" ui-options="{
        ...
        <tbody>
                                        <?php
                                            ...
                                            {
                                              $sales_list_query = "select * from transaction where merchant_id ='".$_SESSION['merchantid']."' order by sno desc ";                                            
                                              
                                            } 
                                            else
                                            {
                                              $sales_list_query = "select * from transaction order by sno desc ";                                            
                                            ...
                                            while($sales_list_row = mysql_fetch_array($sales_list_mysql))
                                            {
                                                ...
                                                $user_name = $sales_list_row['user_name'];
                                                $user_phone = $sales_list_row['user_phone'];
                                                $user_email = $sales_list_row['user_email'];
                                                $transaction_id = $sales_list_row['transaction_id'];
                                                $order_id = $sales_list_row['order_id'];
