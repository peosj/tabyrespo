...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3" style="text-align: center;font-weight: bold;">Closed Tickets</h1>
</div>
      ...
      <table ui-jq="dataTable" ui-options="{
        ...
        <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sales_list_query = "select * from support where user_id = '".$_SESSION['logid']."' AND user_type = 'user' AND ticket_type = 'Closed' order by support_id desc ";                                            
...

                                            {
                                                ...
                                                $registered_email = $sales_list_row['support_type'];
