...
<div class="fRow">
    <div class="form-group">
        ...
        <input class="form-control numeric-textbox" id="prpdamount" name="TxnAmount" type="tel"  autocomplete ="off" placeholder="Enter Recharge Amount" value=""> 
        </div>
        <span class="" style="font-size: 10px; color: #ff0000;display: none;" id="amnterror">Maximum Transaction Limit Exceeded RM 30000</span>
        <span class="" style="font-size: 10px; color: #ff0000;display: none;" id="amnterror1">Transaction Amount is Lower than the Minimum Limit RM1.00</span>
    </div>
</div>
...
<span class="" style="font-size: 10px; color: #ff0000;display: none;" id="amnterror_b2b">Maximum Transaction Limit Exceeded RM 1000000</span>
<span class="" style="font-size: 10px; color: #ff0000;display: none;" id="amnterror1_b2b">Transaction Amount is Lower than the Minimum Limit RM 2.00</span>
</div>
</div>
<div class="fRow rechargetext">
<p class="bg-success " style="padding:14px;"></p> </div><div class="space">&nbsp;</div><span class="Recharge-btn"><cite></cite>
