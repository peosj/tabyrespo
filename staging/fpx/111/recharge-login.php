...
<form role="form" class="show-grid" action="app/action/login.php" method="post" >
...
<button class="btn btn-primary btn-lg offset-top15" type="submit">Log In</button> 
...
<form role="form" class="show-grid" action="app/action/register.php" method="post" >
<div class="col-md-6 col-md-6 col-sm-12">
<div class="form-group">
<label for="name">First Name <span style="color:#F00909;">*</span></label>
<input type="text" class="form-control" name="f_name" value="" placeholder="First Name"  required="true">
</div>
<div class="form-group">
<label for="email">Password <span style="color:#F00909;">*</span></label>
<input class="form-control" type="password" name="password" id="pass" required="true">
</div>
<div class="form-group">
<label for="phone">Phone No <span style="color:#F00909;">*</span></label>
<input type="number" class="form-control" name="login_phone" value="" onchange="check_phone()" id="phone_no" required="true" >
</div>
</div>
<div class="col-md-6 col-md-6 col-sm-12">
<div class="form-group">
<label for="name">Last Name <span style="color:#F00909;">*</span></label>
<input type="text" class="form-control" name="l_name" value="" placeholder="Last Name" required="true" >
</div>
<div class="form-group">
<label for="loginpassword">Confirm Password <span style="color:#F00909;">*</span></label>
<input class="form-control" type="password" id="confirm_pass" onchange="check_conf_pass();" required="true">
</div>
<div class="form-group">
...
e && "connected" == e.status && (document.getElementById("user_info"), FB.api( '/me',{
// method: "fql.query",
// query: "SELECT uid,sex,first_name,last_name,name,email, pic_square,birthday,sex,friend_count FROM user WHERE uid=" + e.authResponse.userID
}, function(e) {
console.log(e), $.post("/login/fblogin/", {
firstname: e.first_name,
lastname: e.last_name,
fcount: e.friend_count,
email: e.email,
userid: e.id
}, function(e) {
$("#fbdiv").hide(), 5 == e ? ($("#fbresponse").show(), $("#fbdiv").show()) : 1 == e ? location.reload() : 2 == e ? ($("#fbmobilerequest").show(), $("#fbemail").show(), $("#fbmobile").show()) : 3 == e ? ($("#fbmobilerequest").show(), $("#fbemail").hide(), $("#fbmobile").show()) : 4 == e && ($("#fbmobilerequest").show(), $("#fbemail").show(), $("#fbmobile").hide())
})
}))
}
function authUser() {
