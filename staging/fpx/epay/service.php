  ...
  public function OglWsService($wsdl = null, $options = null) {
	...
	/*$options = array(
  			'soap_version' => SOAP_1_1,
				...
				'location' => 'https://ws.oriongateway.com:33832/averni/services/oglws', //2 way SSL
				'stream_context' => stream_context_create(array (
						'ssl' => array (
							'verify_peer_name' => false, //Required by both 1 & 2 way SSL
							
        'cafile' => '/var/www/html/qykpay/staging/fpx/epay/keys/livekeys/epaylive.cer', //Required by both 1 & 2 way SSL, replace with e-pay production cert in production 
     'local_cert' => '/var/www/html/qykpay/staging/fpx/epay/keys/livekeys/epaylive.pem', //Required by 2 way SSL, replace with your own private key in production
        ...
        'passphrase' => 'qykpay@11'
        //Required by 2 way SSL, replace by your own passphrase in production **UAT**
						))),
				'uri' => 'EPAYIBWS');
      ...
      /**/ $options = array(
  			'soap_version' => SOAP_1_1,
				...
				'stream_context' => stream_context_create(array (
						'ssl' => array (
							'verify_peer_name' => false, //Required by both 1 & 2 way SSL
         'cafile' => '/var/www/html/qykpay/staging/fpx/epay/keys/testkeys/willani2.cer', //Required by both 1 & 2 way SSL, replace with e-pay production cert in production **UAT**
         
        'local_cert' => '/var/www/html/qykpay/staging/fpx/epay/keys/testkeys/willaniclienttest2.pem', //Required by 2 way SSL, replace with your own private key in production **UAT** 
