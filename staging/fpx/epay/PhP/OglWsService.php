  ...
  public function OglWsService($wsdl = null, $options = null) {
	...
	$options = array(
  			'soap_version' => SOAP_1_1,
				...
				'location' => 'https://wstest.oriongateway.com:22832/willani/services/oglws', //2 way SSL
				'stream_context' => stream_context_create(array (
						'ssl' => array (
							'verify_peer_name' => false, //Required by both 1 & 2 way SSL
							'cafile' => 'willaniclienttest2.cer', //Required by both 1 & 2 way SSL, replace with e-pay production cert in production
							'local_cert' => 'willaniclienttest2.pem', //Required by 2 way SSL, replace with your own private key in production
							 //Command to convert from p12 to pem:-
				 //#openssl pkcs12 -in willaniclienttest2.p12 -out willaniclienttest2.pem -clcerts
							'passphrase' => 'willanitest2' //Required by 2 way SSL, replace by your own passphrase in production
						))),
				'uri' => 'EPAYIBWS');
