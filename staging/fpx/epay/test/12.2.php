...
$requestMsg->orgTransRef='EPA000027597';
$requestMsg->retTransRef="100610Test141";
$requestMsg->terminalId="10000177";
$requestMsg->productCode="CELCOMBILL";
$requestMsg->msisdn='0812345678';
...
$response = $soapclient->__soapCall('etopupReversal', array($params1), array(
            'uri' => 'urn:EPAYIBWS',
            'soapaction' => ''
           ));
var_dump($response);
