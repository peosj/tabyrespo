...
$requestMsg->retTransRef="100610Test209";
$requestMsg->terminalId="10000177";
$requestMsg->productCode="MERCHANTST";
$requestMsg->msisdn=1;
$requestMsg->transDateTime=$timestamp;
...
$response = $soapclient->__soapCall('onlinePIN', array($params1), array(
            'uri' => 'urn:EPAYIBWS',
            'soapaction' => ''
           ));
var_dump($response);
