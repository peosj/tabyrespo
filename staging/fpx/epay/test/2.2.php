...
$requestMsg->amount="3000";
$requestMsg->merchantId="201993";
$requestMsg->operatorId="IBS";
$requestMsg->orgTransRef='1309121309122398';
$requestMsg->retTransRef="100610Test120";
...
$response = $soapclient->__soapCall('onlinePINReversal', array($params1), array(
            'uri' => 'urn:EPAYIBWS',
            'soapaction' => ''
           ));
var_dump($response);
