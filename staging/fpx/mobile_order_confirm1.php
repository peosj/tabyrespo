...
//ECHO $_GET['fpx_buyerBankId'];  EXIT;
//var_dump($_SESSION);
//exit;
...
$fpx_txnAmount      =$_GET['fpx_txnAmount'];
$fpx_buyerEmail     =$_GET['fpx_buyerEmail'];
$fpx_buyerBankId    =$_GET['fpx_buyerBankId'];
$fpx_sellerOrderNo  =$_GET['fpx_sellerOrderNo'];
