...
<input class="form-control" name="Couponcode" id="Couponcode" placeholder="Coupon / Voucher Code" type="hidden">
...
<button type="submit" name="proceed" class=" col-lg-6 col-md-6 col-sm-6" style="background: #ffffff;padding-top: 3px;padding-bottom: 3px;height: 67px;" >
    <div  style="padding:0px !important;">
         <p><span  class="btn btn-default" style="color: #ffffff; background: #1fb2e8;"> Proceed </span></p>
    </div>
</button>
