...
class signup{
    ...
    function __Construct(){
        ...
        public function setSignup($firstname, $lastname, $email, $phone, $password){
...

        {
            ...
            $res = mysql_query("insert into users (firstname, lastname, email, phone, password, date, otp, otp_timestamp, status) values('".$firstname."', '".$lastname."', '".$email."', '".$phone."', '".$password."', '".$date."', '".$otp."', '".$otp_timestamp."', '0')");
                                                                          ...
                                                                          <tr>
                                                                             ...
                                                                             <table>
                                                                                ...
                                                                                <tr height='25'>                                                                
                                                                                    ...
                                                                                    <td align='left' valign='middle' height='25' style='color: #226203; font-family: corbel; font-size:17px; font-weight:bold;'>Dear ".$firstname." ".$lastname."</td>
                                                                                ...
                                                                                <tr height='100'>                                                                
                                                                                    ...
                                                                                    <td align='left' valign='middle' height='100' style='color: #444444; font-family: calibri; font-size:14px; line-height:18px; text-align:justify;padding-right:10px;'>
                                                                                        ...
                                                                                        Here is a one-time verification code to complete your signup process. 

                                                                                        <br /><br />                                                                    

                                                                                        Your OTP = <span style='color:#226203'><strong>".$otp."</strong></span>

                                                                                        <br /><br />                                                                    

                                                                                        Valid for = <span style='color:#226203'><strong>60 Minutes</strong></span>

                                                                                        <br /><br />

                                                                                        If you did not request OTP, please let us know immediately at <a href='mailto:care@qykshuttle.com' style='color: #226203;'>info@qykshuttle.com</a>
