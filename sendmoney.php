...
if((isset($_GET['number']) && isset($_GET['TxnAmount'])))
{
    $uid    = $_GET['uid'];
    $number = $_GET['number'];
    $operator = 'SendMoney';
    ...
    $_SESSION['logphone']           = $number;//phone;
    $_SESSION['number']             = $number;
    $_SESSION['seller_order_no']    = $fpx_sellerOrderNo;
    $_SESSION['receiver_userid']    = $receiver_userid;
    $_SESSION['source']    = $source;

    $_SESSION['transaction_type']   = 1; 
...
<form name="form1" method="post" action="mobile_order_confirm1.php" >
